...
public class DeploymentStage extends Stage {
    ...
    public DeploymentStage(Construct parent, String id, StageProps props, DeploymentEnv env) {
        super(parent, id, props);

        commonStack = new CommonStack(this, "CommonResources", env);
        ipAuthorizerStack = new IpAuthorizerStack(this, "IpAuthorizerApi", commonStack);
