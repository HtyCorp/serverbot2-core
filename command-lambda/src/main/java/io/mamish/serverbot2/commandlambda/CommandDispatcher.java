...
public class CommandDispatcher extends AbstractApiRequestDispatcher<ICommandHandler,CommandServiceResponse,CommandServiceRequest,CommandServiceRequest> {
    ...
    // This method is the one mainly responsible for filtering user-visible error messages in Discord.
    @Override
    protected CommandServiceResponse serializeErrorObject(ApiException exception) {
        // UnknownRequestException message is generated by AbstractApiRequestDispatcher.handleRequest,
        // so it doesn't have a user-friendly message created by this module. So, make one:
